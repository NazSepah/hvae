...
class PlotRocSeg:
    ...
    def on_epoch_end(self, callback_data, nb_imgs, mode_value, epoch):
        ...
        hpu_net = HierarchicalProbUNet(name='model/HPUNet')
        y_pred_newt2_post_tf = tf.nn.sigmoid(hpu_net.reconstruct(img1_tf, img2_tf, 'post'))
        y_pred_newt2_prior_tf = tf.nn.sigmoid(hpu_net.reconstruct(img1_tf, img2_tf, 'post'))
